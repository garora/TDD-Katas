...
{
    [TestFixture]
    [Category("The Recently Used List Kata NET Core")]
    public class RecentlyUsedListTest
    {
        ...
        public void CanAddItems()
        {
            ...
            Assert.That(listCount, Is.GreaterThan(0),
                string.Format("List items count should be Greater than {0} but is {1}", 0, listCount));
        }
